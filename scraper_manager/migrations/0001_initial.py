    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "timeout",
                    models.IntegerField(default=300, help_text="Timeout in seconds"),
                ),
                (
                    "retry_count",
                    models.IntegerField(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="scraper_man_source_89f87f_idx",
                    ),
                    models.Index(
                        fields=["-last_scraped"], name="scraper_man_last_sc_4d836a_idx"
                    ),
                ],
            },
        ),
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["-created_at"], name="scraper_man_created_f9d645_idx"
                    ),
                    models.Index(
                        fields=["status"], name="scraper_man_status_7c4e70_idx"
                    ),
                    models.Index(
                        fields=["scraper_name"], name="scraper_man_scraper_1cc93b_idx"
                    ),
                ],
            },
        ),
