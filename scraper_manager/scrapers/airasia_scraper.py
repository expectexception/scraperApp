...
class AirAsiaScraper(BaseScraper):
    """
    Scraper for AirAsia
    URL: https://mycareer.airasia.com/gb/en/search-results
    """
    def __init__(self, config: Dict[str, Any], db_manager=None):
        super().__init__(config, site_key="airasia", db_manager=db_manager)
        self.base_url = "https://mycareer.airasia.com/gb/en/search-results"
        self.company_name = "AirAsia"
            ...
            try:
                ...
                for link in links:
                    ...
                    try:
                        ...
                        if "airasia.com" in href_lower and any(kw in href_lower for kw in ["/job/", "job-details", "vacancy"]):
                            ...
                            job_id = f"airasia_{abs(hash(job_url)) % 10000000}"
                            jobs.append({
                                "job_id": job_id,
                                "title": text,
                                ...
                                "url": job_url,
                                "apply_url": job_url,
                                "location": "Malaysia", # Hardcoded to country
                            })
                    except:
                        continue
