...
class DATScraper(BaseScraper):
    """
    Scraper for DAT (Danish Air Transport)
    URL: https://dat.dk/corporate/careers
    """

    def __init__(self, config, db_manager=None):
        super().__init__(config, site_key="dat", db_manager=db_manager)
        self.base_url = "https://dat.dk/corporate/careers"
        self.company_name = "DAT (Danish Air Transport)"
            ...
            try:
                ...
                links = await page.evaluate("""() => {
                    return Array.from(document.querySelectorAll('a'))
                        ...
                        .filter(a => a.t && a.t.length > 5 && (a.h.includes('career') || a.h.includes('job')))
                }""")
                ...
                for i, (url, title) in enumerate(job_urls):
                    ...
                    try:
                        ...
                        real_title = (
                            title if title.lower() != "learn more" else slug_title
                        )
                        ...
                        description = ""
                        detail_page.locator("main, article, .job-description, .content")
