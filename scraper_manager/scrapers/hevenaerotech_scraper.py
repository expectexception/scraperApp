...
class HevenAerotechScraper(BaseScraper):
    """
    Scraper for Heven Aerotech (Greenhouse)
    URL: https://boards-api.greenhouse.io/v1/boards/hevenaerotech/jobs
    """

    def __init__(self, config, db_manager=None):
        super().__init__(config, site_key="hevenaerotech", db_manager=db_manager)
        self.api_url = "https://boards-api.greenhouse.io/v1/boards/hevenaerotech/jobs"
        self.company_name = "Heven Aerotech"
            ...
            for job_entry in jobs_list:
                ...
                try:
                    ...
                    if detail_res.status_code == 200:
                        ...
                        job = get_job_dict(
                            job_id=f"hevenaerotech_{item_id}",
                            title=title,
