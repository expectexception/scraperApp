...
class CanadianNorthScraper(BaseScraper):
    """Scraper for Canadian North Airlines using their UKG Pro (Ultipro) portal via Playwright."""

    def __init__(self, config: Dict, db_manager=None):
        super().__init__(config, site_key="canadian_north", db_manager=db_manager)
        self.base_url = "https://recruiting.ultipro.ca/BRA50007F/JobBoard/2ea5e84a-bfc4-4167-88ba-20d03547d410/"
        self.company_name = "Canadian North"
    ...
    async def fetch_jobs(self) -> List[Dict]:
        ...
        async with async_playwright() as p:
            ...
            try:
                # Add query parameters for sorting by date desc
