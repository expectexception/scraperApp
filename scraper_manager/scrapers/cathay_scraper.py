            ...
            try:
                ...
                try:
                    ...
                    await page.wait_for_selector(
                        "a.search-listing__item", timeout=20000
                    )

                    # Accept cookies if needed (generic check)
                    try:
                        await page.locator(".cookie-consent-accept-all").click(
                            timeout=3000
                        )
                    except:
                        pass
                ...
                while True:
                    ...
                    for item in job_items:
                        ...
                        try:
                            ...
                            loc_el = item.locator(
                                ".search-listing__item__info span"
                            ).first
                            location = (
                    ...
                    if await next_btn.is_visible():
                        ...
                        if "disabled" in classes.lower():
                            logger.info(
                                f"[{self.site_key}] Next button disabled. Reached end."
                            )
                            break
                        ...
                        await page.wait_for_selector(
                            "a.search-listing__item", timeout=10000
                        )

                    else:
                        logger.info(
                            f"[{self.site_key}] No next button found. Reached end."
                        )
                        break
                        ...
                        if await apply_btn.count():
                            ...
                            if href:
                                job["apply_url"] = (
                                    ...
                                    else f"https://careers.cathaypacific.com{href}"
                                )
