...
class AirXScraper(BaseScraper):
    """
    Scraper for AirX
    URL: https://www.airx.aero/careers/
    """
    def __init__(self, config: Dict[str, Any], db_manager=None):
        super().__init__(config, site_key="airx", db_manager=db_manager)
        self.base_url = "https://www.airx.aero/careers/"
        self.company_name = "AirX"
            ...
            try:
                ...
                for link in links:
                    ...
                    try:
                        ...
                        if "airx.aero" in href_lower and any(kw in href_lower for kw in ["/career", "/job", "vacancy"]):
                            ...
                            job_id = f"airx_{abs(hash(job_url)) % 10000000}"
                            jobs.append({
                                "job_id": job_id,
                                "title": text,
