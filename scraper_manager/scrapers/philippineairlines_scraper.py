...
class PhilippineAirlinesScraper(BaseScraper):
    """
    Scraper for Philippine Airlines
    URL: https://careers.philippineairlines.com/go/Ground-And-Admin-Employees/734744/
    """
    def __init__(self, config: Dict[str, Any], db_manager=None):
        super().__init__(config, site_key="philippineairlines", db_manager=db_manager)
        self.base_url = "https://careers.philippineairlines.com/go/Ground-And-Admin-Employees/734744/"
        self.company_name = "Philippine Airlines"
            ...
            try:
                ...
                for link in links:
                    ...
                    try:
                        ...
                        if "philippineairlines.com/job/" in href_lower:
                            ...
                            job_id = f"philippineairlines_{abs(hash(job_url)) % 10000000}"
                            jobs.append({
                                "job_id": job_id,
                                "title": text,
        ...
        async with async_playwright() as p:
            ...
            for job in jobs:
                try:
                    ...
                    desc = ""
                    selectors = [".job-description", ".job-layout", "main"]
