...
class StarlinkAviationScraper(BaseScraper):
    """
    Scraper for Starlink Aviation (Workable)
    URL: https://starlinkaviation.com/careers/job-openings/
    API: https://apply.workable.com/api/v3/accounts/starlink-aviation/jobs
    """

    def __init__(self, config, db_manager=None):
        super().__init__(config, site_key="starlinkaviation", db_manager=db_manager)
        self.base_url = "https://starlinkaviation.com/careers/job-openings/"
        self.api_url = "https://apply.workable.com/api/v3/accounts/starlink-aviation/jobs"
        self.company_name = "Starlink Aviation"

    async def fetch_jobs(self) -> list:
        jobs = []
        logger.info(
            f"[{self.site_key}] Querying Workable API directly for Starlink Aviation jobs..."
        )
        ...
        try:
            ...
            for j in results:
                ...
                url = f"https://apply.workable.com/starlink-aviation/j/{shortcode}/"
