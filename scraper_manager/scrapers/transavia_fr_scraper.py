...
class TransaviaFrScraper(BaseScraper):
    """
    Scraper for Transavia France
    URL: https://recrutement.transavia.com/fr/annonces
    """
    def __init__(self, config: Dict[str, Any], db_manager=None):
        super().__init__(config, site_key="transavia_fr", db_manager=db_manager)
        self.base_url = "https://recrutement.transavia.com/fr/annonces"
        self.company_name = "Transavia France"
                ...
                for link in links:
                    ...
                    try:
                        ...
                        if "recrutement.transavia.com/fr/annonce" in href_lower:
                            ...
                            job_id = f"transavia_fr_{abs(hash(job_url)) % 10000000}"
                            jobs.append({
                                "job_id": job_id,
                                "title": text,
