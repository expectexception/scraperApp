        ...
        async with async_playwright() as p:
            ...
            try:
                ...
                while len(jobs) < (self.max_jobs or 50):
                    ...
                    await page.wait_for_selector('.job-tile', state='attached', timeout=15000)
                    ...
                    for item in job_items:
                        ...
                        try:
                            ...
                            job_data = get_job_dict(
                                ...
                                posted_date=self.parse_posted_date(item['posted_date_raw']) if item['posted_date_raw'] else None
                            )
