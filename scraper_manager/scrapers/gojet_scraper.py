...
class GoJetScraper(BaseScraper):
    """Scraper for GoJet Airlines (ADP Workforce Now)"""

    def __init__(self, config, db_manager=None):
        super().__init__(config, site_key="gojet", db_manager=db_manager)
        self.site_config = config.get("sites", {}).get("gojet", {})
        self.base_url = "https://workforcenow.adp.com"
        self.api_url = "https://workforcenow.adp.com/mascsr/default/careercenter/public/events/staffing/v1/job-requisitions?cid=a7828c0b-d30d-40a2-a3ee-61c80628985c&ccId=19000101_000001&lang=en_US"
        self.detail_api_base = "https://workforcenow.adp.com/mascsr/default/careercenter/public/events/staffing/v1/job-requisitions"
        self.company_name = "GoJet Airlines"
    ...
    async def fetch_jobs(self) -> list:
        ...
        try:
            ...
            for req in requisitions:
                ...
                # ADP location usually in requisitionLocations
                location = "Unknown"
                ...
                # Standard ADP job link
                job_url = f"https://workforcenow.adp.com/mascsr/default/mdf/recruitment/recruitment.html?cid=a7828c0b-d30d-40a2-a3ee-61c80628985c&ccId=19000101_000001&lang=en_US&jobId={item_id}"
                
                job_id = f"gojet_{abs(hash(item_id)) % 10000000}"
    ...
    async def fetch_job_descriptions(self, jobs: list) -> list:
        ...
        for job in jobs:
            try:
                ...
                detail_url = f"{self.detail_api_base}/{item_id}?cid=a7828c0b-d30d-40a2-a3ee-61c80628985c&ccId=19000101_000001&lang=en_US"
