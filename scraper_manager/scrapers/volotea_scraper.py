...
class VoloteaScraper(BaseScraper):
    """
    Scraper for Volotea
    URL: https://jobs.volotea.com/hq/
    """
    def __init__(self, config: Dict[str, Any], db_manager=None):
        super().__init__(config, site_key="volotea", db_manager=db_manager)
        self.base_url = "https://jobs.volotea.com/hq/"
        self.company_name = "Volotea"
            ...
            try:
                ...
                for link in links:
                    ...
                    try:
                        ...
                        if "volotea.com/jobs/" in href_lower or "/job/" in href_lower:
                            ...
                            job_id = f"volotea_{abs(hash(job_url)) % 10000000}"
                            jobs.append({
                                "job_id": job_id,
                                "title": text,
