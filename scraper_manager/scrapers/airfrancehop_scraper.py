    ...
    async def fetch_jobs(self) -> list:
        ...
        async with async_playwright() as p:
            ...
            try:
                ...
                skip_words = ['faq', 'news', 'linkedin', 'contact', 'home', 'politique', 'confidentialite', 'legal', 'privacy', 'cookies', 'mentions-legales']
                ...
                for i, (url, initial_title) in enumerate(job_urls):
                    ...
                    try:
                        ...
                        if await title_loc.count() > 0 and await title_loc.first.is_visible():
                        ...
                        description = ""
                        desc_loc = detail_page.locator('.entry-content, main, article, .content')
