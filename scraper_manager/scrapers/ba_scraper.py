            ...
            try:
                ...
                while True:
                    ...
                    for item in job_items:
                        ...
                        try:
                            ...
                            if not link.startswith("http"):
                                link = (
                                    f"https://careers.ba.com{link}"
                                    if link.startswith("/")
                                    else f"https://careers.ba.com/{link}"
                                )
                    ...
                    if await next_btn.is_visible():
                        ...
                        if not href or href == "#":
                            logger.info(
                                f"[{self.site_key}] Next button has no link. Reached end."
                            )
                            break
                        ...
                        if await apply_btn.count():
                            ...
                            if href:
                                job["apply_url"] = (
                                    ...
                                    else f"https://careers.ba.com{href}"
                                )
