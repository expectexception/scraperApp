...
class AirEuropaExpressScraper(BaseScraper):
    ...
    def __init__(self, config, db_manager=None):
        ...
        self.base_url = "https://www.infojobs.net/air-europa/em-i138127453086788506161413812607"
    ...
    async def fetch_jobs(self) -> list:
        ...
        try:
            ...
            if resp.status_code == 200:
                ...
                matches = re.findall(r'href="([^"]*(?:trabajo|empleo|career|job)[^"]*)"[^>]*>([^<]+)</a>', resp.text, re.I)
                for href, title in matches:
                    if self.is_job_link(title, href):
                        url = href if 'http' in href else f"https://www.aireuropa.com{href}"
