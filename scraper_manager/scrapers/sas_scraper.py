...
class SASScraper(BaseScraper):
    """
    Scraper for SAS Scandinavian Airlines.
    URL: https://careers.sasgroup.net/
    """
    
    def __init__(self, config, db_manager=None):
        super().__init__(config, site_key='sas', db_manager=db_manager)
        self.base_url = "https://careers.sasgroup.net/search/"
        self.company_name = "SAS Scandinavian Airlines"
            ...
            try:
                ...
                for i, (url, title) in enumerate(job_urls):
                    ...
                    try:
                        ...
                        description = ""
                        for loc in ['.jobdescription', '.job-description', 'main', 'article']:
