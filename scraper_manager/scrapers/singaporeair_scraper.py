...
class SingaporeAirScraper(BaseScraper):
    """
    Scraper for Singapore Airlines
    URL: https://careers.singaporeair.com/sia/go/Ground-Professionals/689144/
    """
    def __init__(self, config: Dict[str, Any], db_manager=None):
        super().__init__(config, site_key="singaporeair", db_manager=db_manager)
        self.base_url = "https://careers.singaporeair.com/sia/go/Ground-Professionals/689144/"
        self.company_name = "Singapore Airlines"
                ...
                for link in links:
                    ...
                    try:
                        ...
                        if "singaporeair.com/job/" in href_lower:
                            ...
                            job_id = f"singaporeair_{abs(hash(job_url)) % 10000000}"
                            jobs.append({
                                "job_id": job_id,
                                "title": text,
