...
class BreezeAirwaysScraper(BaseScraper):
    """
    Scraper for Breeze Airways (Greenhouse)
    URL: https://boards-api.greenhouse.io/v1/boards/breezeairways/jobs
    """

    def __init__(self, config, db_manager=None):
        super().__init__(config, site_key="breeze_airways", db_manager=db_manager)
        self.api_url = "https://boards-api.greenhouse.io/v1/boards/breezeairways/jobs"
        self.company_name = "Breeze Airways"
                ...
                try:
                    ...
                    if detail_res.status_code == 200:
                        ...
                        job = get_job_dict(
                            ...
                            apply_url=url,
                            posted_date=job_entry.get("updated_at"),
