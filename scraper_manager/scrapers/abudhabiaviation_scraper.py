...
class AbuDhabiAviationScraper(BaseScraper):
    ...
    def __init__(self, config, db_manager=None):
        ...
        self.jobs_url = self.site_config.get('jobs_url', 'https://ada.ae/general-application/')
    ...
    async def fetch_jobs_from_listing(self):
        ...
        async with async_playwright() as p:
            ...
            try:
                ...
                selectors = ['.career-item', '.job-post', '.accordion-item', '.job-listing', 'li.job']
                job_elements = []
                ...
                if job_elements:
                     for idx, el in enumerate(job_elements):
                         ...
                         try:
                             ...
                             title_el = await el.query_selector('h3, h4, h5, .title, .job-title, a')
                             if not title_el:
                                  continue
                             ...
                             desc_el = await el.query_selector('.description, .content, .job-content, p')
                             description = ''
                             if desc_el:
                    ...
                    logger.info("No structured job elements found, scanning page text...")
                    ...
                    if 'careers@abudhabiaviation.com' in body_text.lower() or 'hr@abudhabiaviation.com' in body_text.lower():
