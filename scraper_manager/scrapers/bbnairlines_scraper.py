...
class BBNAirlinesScraper(BaseScraper):
    """
    Scraper for BBN Airlines
    URL: https://bbnairlines.aero/careers/
    """
    def __init__(self, config: Dict[str, Any], db_manager=None):
        super().__init__(config, site_key="bbnairlines", db_manager=db_manager)
        self.base_url = "https://bbnairlines.aero/careers/"
        self.company_name = "BBN Airlines"
            ...
            try:
                ...
                for link in links:
                    ...
                    try:
                        ...
                        if "bbnairlines.aero" in href_lower and any(kw in href_lower for kw in ["/career/", "/job", "vacancy"]):
                            ...
                            job_id = f"bbnairlines_{abs(hash(job_url)) % 10000000}"
                            jobs.append({
                                "job_id": job_id,
                                "title": text,
