...
class MagmaScraper(BaseScraper):
    """
    Scraper for Magma Aviation
    URL: https://magma.aero/careers/
    """
    def __init__(self, config: Dict[str, Any], db_manager=None):
        super().__init__(config, site_key="magma", db_manager=db_manager)
        self.base_url = "https://magma.aero/careers/"
        self.company_name = "Magma Aviation"
            ...
            try:
                ...
                for link in links:
                    ...
                    try:
                        ...
                        if "magma.aero" in href_lower and any(kw in href_lower for kw in ["careers/", "vacancy", "job"]):
                            ...
                            job_id = f"magma_{abs(hash(job_url)) % 10000000}"
                            jobs.append({
                                "job_id": job_id,
                                "title": text,
