...
class FlyAllianceScraper(BaseScraper):
    """
    Scraper for Fly Alliance
    URL: https://flyalliance.com/careers/
    """
    def __init__(self, config: Dict[str, Any], db_manager=None):
        super().__init__(config, site_key="flyalliance", db_manager=db_manager)
        self.base_url = "https://flyalliance.com/careers/"
        self.company_name = "Fly Alliance"
            ...
            try:
                ...
                for link in links:
                    ...
                    try:
                        ...
                        if "flyalliance.com" in href_lower and any(kw in href_lower for kw in ["careers", "job", "vacancy"]):
                            ...
                            job_id = f"flyalliance_{abs(hash(job_url)) % 10000000}"
                            jobs.append({
                                "job_id": job_id,
                                "title": text,
        ...
        async with async_playwright() as p:
            ...
            for job in jobs:
                try:
                    ...
                    desc = ""
                    selectors = [".entry-content", ".content", "main"]
