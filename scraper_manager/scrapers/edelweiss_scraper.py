...
class EdelweissScraper(BaseScraper):
    ...
    def __init__(self, config, db_manager=None):
        ...
        self.base_url = "https://apply.lufthansagroup.careers/index.php?ac=search_result&search_criterion_division[]=5988&language=2"
        self.company_name = "Edelweiss Air"

    async def fetch_jobs(self) -> list:
        logger.info(
            f"[{self.site_key}] Navigating to Lufthansa group careers portal proxy..."
        )
        jobs = []
