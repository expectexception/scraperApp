...
class LynnScraper(BaseScraper):
    """
    Scraper for Lynn Careers (Workday)

    Uses Internal Workday API:
    POST https://lynn.wd5.myworkdayjobs.com/wday/cxs/lynn/Careers/jobs
    """

    def __init__(self, config: Dict[str, Any], db_manager=None):
        super().__init__(config, site_key="lynn", db_manager=db_manager)
        self.base_url = "https://lynn.wd5.myworkdayjobs.com/Careers"
        self.api_url = "https://lynn.wd5.myworkdayjobs.com/wday/cxs/lynn/Careers/jobs"
        self.company_name = "Lynn"

    async def fetch_jobs(self) -> List[Dict[str, Any]]:
        """
        Scrape jobs from Lynn Workday API (Listing only)
        """
        jobs = []
        ...
        async with async_playwright() as p:
            ...
            try:
                ...
                site_config = self.config.get("scrapers", {}).get("lynn", {})
                    ...
                    while self.max_jobs is None or len(jobs) < self.max_jobs:
                        ...
                        try:
                            ...
                            for item in job_items:
                                ...
                                url = (
                                    f"https://lynn.wd5.myworkdayjobs.com/Careers{external_path}"
                                    if external_path
                                    else self.base_url
                                )
        ...
        async with async_playwright() as p:
            ...
            for job in jobs:
                ...
                try:
                    ...
                    desc_url = f"https://lynn.wd5.myworkdayjobs.com/wday/cxs/lynn/Careers/job/{safe_job_id}"
