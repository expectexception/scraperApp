...
class LuxaviationScraper(BaseScraper):
    """
    Scraper for Luxaviation (BambooHR)
    URL: https://luxaviation.bamboohr.com/careers
    """
    def __init__(self, config: Dict[str, Any], db_manager=None):
        super().__init__(config, site_key="luxaviation", db_manager=db_manager)
        self.api_url = "https://luxaviation.bamboohr.com/careers/list"
        self.base_url = "https://luxaviation.bamboohr.com/careers"
        self.company_name = "Luxaviation"
