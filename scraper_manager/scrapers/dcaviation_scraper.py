...
class DCAviationScraper(BaseScraper):
    """
    Scraper for DC Aviation (Recruitee)
    URL: https://dcaviationgmbh.recruitee.com/l/en/
    """
    def __init__(self, config: Dict[str, Any], db_manager=None):
        super().__init__(config, site_key="dcaviation", db_manager=db_manager)
        self.base_url = "https://dcaviationgmbh.recruitee.com/l/en/"
        self.company_name = "DC Aviation"
            ...
            try:
                ...
                for link in links:
                    ...
                    try:
                        ...
                        if "recruitee.com" in href_lower and "/o/" in href_lower:
                            ...
                            job_id = f"dcaviation_{abs(hash(job_url)) % 10000000}"
                            jobs.append({
                                "job_id": job_id,
                                "title": text,
                                ...
                                "url": job_url,
                                "apply_url": job_url,
                                "location": "Germany", # Hardcoded to country
                            })
                    except:
                        continue
        ...
        async with async_playwright() as p:
            ...
            for job in jobs:
                try:
                    ...
                    desc = ""
                    selectors = [".description", ".content", "main"]
