...
class AllegiantAirScraper(BaseScraper):
    """
    Scraper for Allegiant Air
    URL: https://www.allegiantair.jobs/see-all-jobs/
    """
    def __init__(self, config: Dict[str, Any], db_manager=None):
        super().__init__(config, site_key="allegiantair", db_manager=db_manager)
        self.base_url = "https://www.allegiantair.jobs/see-all-jobs/"
        self.company_name = "Allegiant Air"
                ...
                for link in links:
                    ...
                    try:
                        ...
                        if is_own_site_job or is_lever_job:
                            ...
                            job_id = f"allegiantair_{abs(hash(job_url)) % 10000000}"
                            jobs.append({
                                "job_id": job_id,
                                "title": text,
