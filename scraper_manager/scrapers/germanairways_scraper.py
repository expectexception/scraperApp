                ...
                for job in jobs:
                    ...
                    try:
                        ...
                        if await desc_el.count():
                            ...
                            job['description'] = await detail_page.locator('.job-detail-content').first.inner_html() if await detail_page.locator('.job-detail-content').count() else await desc_el.first.inner_html()
                        else:
                        ...
                        if await apply_btn.count():
                             ...
                             if href:
                                 job['apply_url'] = href if href.startswith('http') else f"https://german-airways.jobs.personio.de{href}"
