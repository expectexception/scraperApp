...
class TradewindScraper(BaseScraper):
    """
    Scraper for Tradewind Aviation (Paylocity)
    URL: https://recruiting.paylocity.com/recruiting/jobs/All/508f4046-d9bb-45f4-bd05-bdeaa7c8aa3c/Tradewind
    """

    def __init__(self, config, db_manager=None):
        super().__init__(config, site_key="tradewind", db_manager=db_manager)
        self.base_url = "https://recruiting.paylocity.com/recruiting/jobs/All/508f4046-d9bb-45f4-bd05-bdeaa7c8aa3c/Tradewind"
        self.company_name = "Tradewind"

    async def fetch_jobs(self) -> list:
        jobs = []
        logger.info(f"[{self.site_key}] Fetching Tradewind jobs page...")
