...
class RtxScraper(BaseScraper):
    """
    Scraper for RTX (Raytheon Technologies) / Collins Aerospace / Pratt & Whitney (Phenom People)
    URL: https://careers.rtx.com/global/en/search-results
    """

    def __init__(self, config: Dict, db_manager=None):
        super().__init__(config, site_key="rtx", db_manager=db_manager)
        self.base_url = "https://careers.rtx.com/global/en/search-results"
        self.company_name = "RTX"
