...
class ComluxScraper(BaseScraper):
    """
    Scraper for Comlux (BambooHR)
    URL: https://comlux.bamboohr.com/careers
    """
    def __init__(self, config: Dict[str, Any], db_manager=None):
        super().__init__(config, site_key="comlux", db_manager=db_manager)
        self.api_url = "https://comlux.bamboohr.com/careers/list"
        self.base_url = "https://comlux.bamboohr.com/careers"
        self.company_name = "Comlux"
