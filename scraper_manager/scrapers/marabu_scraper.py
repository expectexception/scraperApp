...
class MarabuScraper(BaseScraper):
    """
    Scraper for Marabu Airlines
    URL: https://apply.workable.com/marabu/
    """

    def __init__(self, config, db_manager=None):
        super().__init__(config, site_key="marabu", db_manager=db_manager)
        self.base_url = "https://apply.workable.com/marabu/"
        self.api_url = "https://apply.workable.com/api/v3/accounts/marabu/jobs"
        self.company_name = "Marabu Airlines"

    async def fetch_jobs(self) -> list:
        jobs = []
        logger.info(
            f"[{self.site_key}] Querying Workable API directly for Marabu jobs..."
        )
        ...
        try:
            ...
            for j in results:
                ...
                url = f"https://apply.workable.com/marabu/j/{shortcode}/"
