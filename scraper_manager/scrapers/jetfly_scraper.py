...
class JetflyScraper(BaseScraper):
    ...
    async def fetch_jobs(self) -> List[Dict]:
        ...
        try:
            ...
            logger.info(f"[{self.site_key}] Found {len(job_cards)} job cards on the page.")
            ...
            logger.info(f"[{self.site_key}] Successfully parsed {len(jobs)} potential new jobs to filter.")
            return jobs
