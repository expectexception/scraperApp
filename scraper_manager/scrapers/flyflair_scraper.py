...
class FlyFlairScraper(BaseScraper):
    """
    Scraper for Flair Airlines
    URL: https://career.flyflair.com/jobs
    """
    def __init__(self, config: Dict[str, Any], db_manager=None):
        super().__init__(config, site_key="flyflair", db_manager=db_manager)
        self.base_url = "https://career.flyflair.com/jobs"
        self.company_name = "Flair Airlines"
            ...
            try:
                ...
                for link in links:
                    ...
                    try:
                        ...
                        if "career.flyflair.com/jobs/" in href_lower:
                            ...
                            job_id = f"flyflair_{abs(hash(job_url)) % 10000000}"
                            jobs.append({
                                "job_id": job_id,
                                "title": text,
