...
class FlyExclusiveScraper(BaseScraper):
    """Scraper for flyExclusive (Paycom) via Playwright API Interception."""

    def __init__(self, config: Dict, db_manager=None):
        super().__init__(config, site_key="flyexclusive", db_manager=db_manager)
        self.base_url = self.config.get(
            "jobs_url", 
            "https://www.paycomonline.net/v4/ats/web.php/portal/91989CEA70627F35DBDEA57AC03E0A2B/career-page"
        )
        self.company_name = self.config.get("name", "flyExclusive")
            ...
            try:
                ...
                for item in api_jobs_data:
                    ...
                    if len(base_parts) > 1:
                        ...
                        job_url = f"https://www.paycomonline.net/v4/ats/web.php/portal/91989CEA70627F35DBDEA57AC03E0A2B/jobs/{job_id}"
