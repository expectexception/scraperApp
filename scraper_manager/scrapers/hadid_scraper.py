...
class HadidScraper(BaseScraper):
    """
    Scraper for Hadid Aviation
    URL: https://hadid.aero/job-vacancies/list
    """
    def __init__(self, config: Dict[str, Any], db_manager=None):
        super().__init__(config, site_key="hadid", db_manager=db_manager)
        self.base_url = "https://hadid.aero/job-vacancies/list"
        self.company_name = "Hadid Aviation"
            ...
            try:
                ...
                for link in links:
                    ...
                    try:
                        ...
                        if "hadid.aero" in href_lower and any(kw in href_lower for kw in ["vacancy", "/job"]):
                            ...
                            job_id = f"hadid_{abs(hash(job_url)) % 10000000}"
                            jobs.append({
                                "job_id": job_id,
                                "title": text,
