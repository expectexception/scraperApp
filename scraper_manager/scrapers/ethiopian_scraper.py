...
class EthiopianScraper(BaseScraper):
    ...
    def __init__(self, config, db_manager=None):
        ...
        self.base_url = "https://corporate.ethiopianairlines.com/AboutEthiopian/careers/vacancies"
            ...
            try:
                ...
                for link in links:
                    ...
                    if href and href not in seen_urls and self.is_job_link(title, href):
                        skip_words = ['home', 'news', 'faq', 'cookie', 'login', 'impressum', 'privacy', 'about', 'vacancies', 'career']
                        ...
                        if 'vacancies' in href.lower() and ('detail' not in href.lower() and 'job' not in href.lower() and len(href.split('/')) < 6):
                            continue
                        seen_urls.add(href)
                ...
                for i, (url, title) in enumerate(job_urls):
                    ...
                    try:
                        ...
                        description = ""
                        desc_loc = detail_page.locator('.job-description, .content, main, article')
