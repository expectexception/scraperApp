...
class HelinetScraper(BaseScraper):
    """
    Scraper for Helinet
    URL: https://helinet.com/careers/
    """
    def __init__(self, config: Dict[str, Any], db_manager=None):
        super().__init__(config, site_key="helinet", db_manager=db_manager)
        self.base_url = "https://helinet.com/careers/"
        self.company_name = "Helinet"
                ...
                for link in links:
                    ...
                    try:
                        ...
                        if "helinet.com/careers/" in href_lower and href_lower != "https://helinet.com/careers/" and "#" not in href_lower:
                            ...
                            job_id = f"helinet_{abs(hash(job_url)) % 10000000}"
                            jobs.append({
                                "job_id": job_id,
                                "title": text,
