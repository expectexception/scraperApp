...
class PngAirScraper(BaseScraper):
    """
    Scraper for PNG Air
    URL: https://www.pngworkforce.com/jobs/view-company/2787/png-air
    """
    def __init__(self, config: Dict[str, Any], db_manager=None):
        super().__init__(config, site_key="pngair", db_manager=db_manager)
        self.base_url = "https://www.pngworkforce.com/jobs/view-company/2787/png-air"
        self.company_name = "PNG Air"
            ...
            try:
                ...
                for link in links:
                    ...
                    try:
                        ...
                        if "pngworkforce.com/jobs/" in href_lower and "/view/" in href_lower:
                            job_url = href
                            ...
                            job_id = f"pngair_{abs(hash(job_url)) % 10000000}"
                            jobs.append({
                                "job_id": job_id,
                                "title": text,
