...
class PhoenixAirGroupScraper(BaseScraper):
    """
    Scraper for Phoenix Air Group (ADP Workforce Now)
    URL: https://workforcenow.adp.com/mascsr/default/mdf/recruitment/recruitment.html?cid=0e1b54aa-e5af-4e0b-90d1-e04e6d0be023&ccId=19000101_000001&lang=en_US
    """

    def __init__(self, config, db_manager=None):
        super().__init__(config, site_key="phoenix_air_group", db_manager=db_manager)
        self.cid = "0e1b54aa-e5af-4e0b-90d1-e04e6d0be023"
        ...
        self.company_name = "Phoenix Air Group"
    ...
    async def fetch_jobs(self) -> list:
        ...
        try:
            ...
            if not response or response.status_code != 200:
                logger.error(f"[{self.site_key}] Failed to fetch from ADP API: Status {response.status_code if response else 'None'}")
                return []
            ...
            for req in requisitions:
                ...
                job_id = f"phoenix_air_group_{item_id}"
