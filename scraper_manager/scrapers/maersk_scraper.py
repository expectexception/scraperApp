...
class MaerskScraper(BaseScraper):
    """
    Scraper for Maersk
    URL: https://www.maersk.com/careers/vacancies?continent=&category=Air+Freight&country=&searchText=&limit=24
    """
    def __init__(self, config: Dict[str, Any], db_manager=None):
        super().__init__(config, site_key="maersk", db_manager=db_manager)
        self.base_url = "https://www.maersk.com/careers/vacancies?continent=&category=Air+Freight&country=&searchText=&limit=24"
    ...
    async def fetch_jobs(self) -> List[Dict[str, Any]]:
        ...
        async with async_playwright() as p:
            ...
            try:
                ...
                try:
                    await page.wait_for_selector('a[href*="careers/vacancies/"]', timeout=10000)
                except:
                    pass
                ...
                for link in links:
                    ...
                    try:
                        ...
                        if "maersk.com/careers/vacancies/" in href_lower:
                            ...
                            job_id = f"maersk_{abs(hash(job_url)) % 10000000}"
                            jobs.append({
                                "job_id": job_id,
                                "title": text,
        ...
        async with async_playwright() as p:
            ...
            for job in jobs:
                try:
                    ...
                    desc = ""
                    selectors = [".job-description", ".vacancy-details", ".content", "main"]
