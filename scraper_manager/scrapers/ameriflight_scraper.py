...
class AmeriflightScraper(BaseScraper):
    """
    Scraper for Ameriflight (Paylocity)
    URL: https://recruiting.paylocity.com/recruiting/jobs/All/ffb2b81c-27ab-41d2-959e-56f9349360aa/Ameriflight-LLC
    """

    def __init__(self, config, db_manager=None):
        super().__init__(config, site_key="ameriflight", db_manager=db_manager)
        self.base_url = "https://recruiting.paylocity.com/recruiting/jobs/All/ffb2b81c-27ab-41d2-959e-56f9349360aa/Ameriflight-LLC"
        self.company_name = "Ameriflight"

    async def fetch_jobs(self) -> list:
        jobs = []
        logger.info(f"[{self.site_key}] Fetching Ameriflight jobs page...")
        ...
        async with async_playwright() as p:
            ...
            try:
                ...
                # We can just extract the HTML and parse with BeautifulSoup
        ...
        async with async_playwright() as p:
            ...
            for job in jobs:
                ...
                try:
                    ...
                    # wait for job-details or similar
                    await asyncio.sleep(2)
                    html = await page.content()
                    soup = BeautifulSoup(html, "html.parser")

                    # The job description in paylocity details is usually within a specific container
                    # Often it's `.job-details-content` or similar
                    content = (
