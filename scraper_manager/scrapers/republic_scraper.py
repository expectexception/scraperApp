...
class RepublicScraper(BaseScraper):
    """
    Scraper for Republic Airways (iCIMS)
    """

    def __init__(self, config, db_manager=None):
        super().__init__(config, site_key="republic", db_manager=db_manager)
        self.base_url = "https://rjet.com/careers"
        self.company_name = "Republic Airways"
                ...
                for row in job_rows:
                    ...
                    try:
                        ...
                        if url and not url.startswith("http"):
                            url = (
                                "https://"
                                + "https://rjet.com/careers".split("/")[2]
                                + url
                            )
