...
class AlexJetsScraper(BaseScraper):
    """
    Scraper for Alex Jets
    URL: https://alexjets.com/modern/career
    """
    def __init__(self, config: Dict[str, Any], db_manager=None):
        super().__init__(config, site_key="alexjets", db_manager=db_manager)
        self.base_url = "https://alexjets.com/modern/career"
        self.company_name = "Alex Jets"
            ...
            try:
                ...
                for link in links:
                    ...
                    try:
                        ...
                        if "alexjets.com" in href_lower and any(kw in href_lower for kw in ["career", "job", "vacancy"]):
                            ...
                            job_id = f"alexjets_{abs(hash(job_url)) % 10000000}"
                            jobs.append({
                                "job_id": job_id,
                                "title": text,
