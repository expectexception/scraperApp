                ...
                while True:
                    ...
                    for row in job_rows:
                        try:
                            ...
                            url = (
                                f"https://recruiting.ultipro.ca{url_suffix}"
                            ...
                            req_el = await row.query_selector(
                                'span[data-bind*="RequisitionNumber"]'
                            )
                            job_id = (
                                await req_el.inner_text() if req_el else str(hash(url))
                            )
                    ...
                    load_more = await page.query_selector(
                        'button[data-automation="load-more"]'
                    )
