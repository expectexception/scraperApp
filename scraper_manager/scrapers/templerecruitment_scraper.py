...
class TempleRecruitmentScraper(BaseScraper):
    """
    Scraper for Temple Recruitment
    URL: https://templerecruitment.ie/jobs/
    """
    def __init__(self, config: Dict[str, Any], db_manager=None):
        super().__init__(config, site_key="templerecruitment", db_manager=db_manager)
        self.base_url = "https://templerecruitment.ie/jobs/"
        self.company_name = "Temple Recruitment"
            ...
            try:
                ...
                for link in links:
                    ...
                    try:
                        ...
                        if "templerecruitment.ie/job" in href_lower:
                            ...
                            job_id = f"templerecruitment_{abs(hash(job_url)) % 10000000}"
                            jobs.append({
                                "job_id": job_id,
                                "title": text,
