...
class FrontierScraper(BaseScraper):
    """Scraper for Frontier Airlines using their UKG Pro (Ultipro) portal via Playwright."""

    def __init__(self, config: Dict, db_manager=None):
        super().__init__(config, site_key="frontier", db_manager=db_manager)
        self.base_url = self.config.get("jobs_url", "https://recruiting2.ultipro.com/FRO1003FTAIR/JobBoard/1efcf859-1b48-4a31-b014-ef62bdcab988/?q=&o=postedDateDesc")
        self.company_name = "Frontier Airlines"
