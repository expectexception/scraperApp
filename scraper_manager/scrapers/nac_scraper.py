...
class NACScraper(BaseScraper):
    """Scraper for Northern Air Cargo (NAC) using their UKG Pro (Ultipro) portal via Playwright."""
    
    def __init__(self, config: Dict, db_manager=None):
        super().__init__(config, site_key='nac', db_manager=db_manager)
        self.base_url = "https://recruiting.ultipro.com/NOR1020NAIRC/JobBoard/be7c5458-8e9f-482c-b6a2-37175c50020d/"
