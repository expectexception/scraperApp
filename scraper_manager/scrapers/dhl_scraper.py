...
class DHLScraper(BaseScraper):
    """
    Scraper for DHL Aviation (Phenom People API)
    URL: https://careers.dhl.com/global/en/search-results
    """

    def __init__(self, config: Dict, db_manager=None):
        super().__init__(config, site_key="dhl", db_manager=db_manager)
        self.base_url = "https://careers.dhl.com/global/en/search-results"
        self.company_name = "DHL"
