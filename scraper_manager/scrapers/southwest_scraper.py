                ...
                while True:
                    ...
                    for item in job_items:
                        ...
                        try:
                            ...
                            location = (await loc_el.text_content() if await loc_el.count() else "Unknown").strip().replace('\n', ' ')
        ...
        async with async_playwright() as p:
            ...
            for job in jobs:
                ...
                try:
                    ...
                    job['description'] = await desc_el.inner_html() if await desc_el.count() else await page.content()
