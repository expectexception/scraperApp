...
class HelveticScraper(BaseScraper):
    """
    Scraper for Helvetic Airways
    URL: https://career.helvetic.com/vacancies
    """
    def __init__(self, config: Dict[str, Any], db_manager=None):
        super().__init__(config, site_key="helvetic", db_manager=db_manager)
        self.base_url = "https://career.helvetic.com/vacancies"
        self.company_name = "Helvetic Airways"
            ...
            try:
                ...
                for link in links:
                    ...
                    try:
                        ...
                        if "career.helvetic.com/vacancies/" in href_lower or "/vacancy/" in href_lower:
                            if text.lower() in ["read more", "apply", "apply now", "view details", "vacancies"]:
                                continue
                            ...
                            job_id = f"helvetic_{abs(hash(job_url)) % 10000000}"
                            jobs.append({
                                "job_id": job_id,
                                "title": text,
        ...
        async with async_playwright() as p:
            ...
            for job in jobs:
                try:
                    ...
                    desc = ""
                    selectors = [".job-description", ".vacancy-description", "main"]
