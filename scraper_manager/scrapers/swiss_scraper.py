...
class SwissScraper(BaseScraper):
    """
    Scraper for SWISS.
    URL: https://apply.lufthansagroup.careers/index.php?ac=search_result&search_criterion_company%5B%5D=5926&language=2
    Lufthansa Group structure.
    """

    def __init__(self, config, db_manager=None):
        super().__init__(config, site_key="swiss", db_manager=db_manager)
        # Direct brand filter: 5926 for Swiss International Air Lines AG
        self.base_url = "https://apply.lufthansagroup.careers/index.php?ac=search_result&search_criterion_company%5B%5D=5926&language=2"
        self.company_name = "Swiss International Air Lines"
            ...
            try:
                ...
                try:
                    cookie_btn = page.locator(
                        "text=Accept all, text=Zustimmen, id=cmplz-accept-all"
                    ).first
