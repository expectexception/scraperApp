        ...
        async with async_playwright() as p:
            ...
            try:
                ...
                while True:
                    ...
                    try:
                        await page.wait_for_selector('div.jl-entry-categories', timeout=15000)
                    except:
                        logger.warning(f"[{self.site_key}] No jobs found or selector timeout on page {page_count}")
                        break
                    ...
                    for row in job_rows:
                        try:
                            ...
                            if loc_el:
                                ...
                                title = full_text.replace(location, "").strip().strip("-").strip()
                            else:
                    ...
                    for job_data in page_jobs_data:
                        ...
                        try:
                            ...
                            desc_el = await detail_page.query_selector('.entry-content, .job-description, .tc-job-listing-description')
                            description = ""
                            if desc_el:
                    ...
                    next_btn = await page.query_selector('a.facetwp-page.next, a.next.page-numbers')
                    if next_btn:
                        ...
                        logger.info(f"[{self.site_key}] No more pages found or pagination not present.")
                        break
