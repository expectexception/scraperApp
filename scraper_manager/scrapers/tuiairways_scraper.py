...
class TuiAirwaysScraper(BaseScraper):
    ...
    def __init__(self, config, db_manager=None):
        ...
        self.base_url = "https://careers.tuigroup.com/en/airline"
            ...
            try:
                ...
                for i, (url, title) in enumerate(job_urls):
                    ...
                    try:
                        ...
                        description = ""
                        for loc in ['.jobdescription', '.job-description', 'main', '.content-body']:
                        ...
                        for loc in ['.jobGeoLocation', '.location', '.job-location-details']:
                            elem = detail_page.locator(loc).first
                            if await elem.is_visible():
