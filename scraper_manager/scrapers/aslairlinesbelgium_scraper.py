...
class ASLAirlinesBelgiumScraper(BaseScraper):
    ...
    def __init__(self, config, db_manager=None):
        ...
        self.base_url = (
            "https://cezanneondemand.intervieweb.it/aslaviationgroup/en/career"
        )
            ...
            try:
                ...
                for i, (url, title) in enumerate(job_urls):
                    ...
                    try:
                        ...
                        description = ""
                        desc_elements = await detail_page.query_selector_all(
                            ".body__text"
                        )
                        if desc_elements:
                        ...
                        if not description:
                            desc_loc = detail_page.locator(
                                "main, .elementor-widget-container, .entry-content, article"
                            )
                        ...
                        loc_elem = await detail_page.query_selector(
                            'span.subtitle__informations[title="Location"]'
                        )
                        if loc_elem:
