"""
Lufthansa Group careers scraper — career.be-lufthansa.com
Covers Lufthansa, SWISS, Austrian Airlines, Brussels Airlines via their SuccessFactors portal.
"""
...
SF_API = "https://career.be-lufthansa.com/api/apply/v2/jobs"


class LufthansaGroupScraper(BaseScraper):
    """Lufthansa Group SuccessFactors scraper (LH, SWISS, Austrian, Brussels)."""
                ...
                if resp.status_code == 200:
                    ...
                    for p in postings:
                        ...
                        if not title or job_id in seen:
                            continue
                        seen.add(job_id)
                        location = p.get("location", "Germany")
                        url = urljoin(
