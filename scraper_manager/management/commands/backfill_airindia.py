...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        qs = Job.objects.filter(source__iexact='Air India', posted_date__isnull=True).order_by('-created_at')
        ...
        total = len(jobs)
        if not jobs:
            self.stdout.write(self.style.SUCCESS('No Air India jobs found that need backfilling.'))
            return
