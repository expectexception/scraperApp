...
urlpatterns = [
    ...
    path(
        "jobs/<str:job_id>/check-status/",
        api.check_job_url_status,
        name="check_job_status",
    ),
    path(
        "jobs/check-status/bulk/",
        api.bulk_check_job_url_status,
        name="bulk_check_job_status",
    ),
    path(
        "jobs/<str:job_id>/delete/", api.update_managed_job, name="delete_managed_job"
    ),
    ...
    path(
        "config/<str:scraper_name>/update/",
        api.update_scraper_config,
        name="update_config",
    ),
    # System metrics
